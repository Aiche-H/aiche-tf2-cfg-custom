...
Every time you switch classes, the game runs `reset.cfg` first. This is crucial because:
...
If you just want to change a key (e.g., move Jump from SPACE to MWHEELUP):
